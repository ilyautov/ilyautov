...
[**moysklad-mcp-ru**](https://github.com/ilyautov/moysklad-mcp-ru). The same for MoySklad, the cloud ERP most Russian retail runs its stock and trade documents in: 892 methods behind 10 generic tools, with a safety gate before anything gets written and a draft before anything gets posted.
